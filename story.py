...
story2 = "\nKäytössä sinulla on pieni sähkö lentokone, jota pystyt hyödyntämään matkustamiseen. Yhteiskuntaa ylläpitävä järjestelmä ei ole enään toimiva, joten joudut itse kerätä tarvittavat resurssin aikamääreen puitteissa ja tavata lopun ryhmästä Floridan Key Westissä."
story = story1 + story2
